...
class Ops:
    ...
    def add(c: Tensor, a: Tensor, b: Tensor):
        LIB_CHAOSUAN.chaosuanAdd(c.lib_tensor(), a.lib_tensor(), b.lib_tensor())

    @staticmethod
    def argmax(max_idx: Tensor, max_val: Tensor, vals: Tensor):
        LIB_CHAOSUAN.chaosuanArgmax(max_idx.lib_tensor(), max_val.lib_tensor(), vals.lib_tensor())

    @staticmethod
    def embedding(out: Tensor, index: Tensor, weight: Tensor):
        LIB_CHAOSUAN.chaosuanEmbedding(
    ...
    def self_attention(attn_val: Tensor, q: Tensor, k: Tensor, v: Tensor, scale: float):
        LIB_CHAOSUAN.chaosuanSelfAttention(
            attn_val.lib_tensor(),
            q.lib_tensor(),
            k.lib_tensor(),
            v.lib_tensor(),
    ...
    def swiglu(out: Tensor, gate: Tensor, up: Tensor):
        LIB_CHAOSUAN.chaosuanSwiGLU(out.lib_tensor(), gate.lib_tensor(), up.lib_tensor())
