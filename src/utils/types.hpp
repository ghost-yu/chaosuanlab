...
namespace utils {
inline size_t dsize(chaosuanDataType_t dtype) {
    switch (dtype) {
    case CHAOSUAN_DTYPE_BYTE:
        return sizeof(char);
    case CHAOSUAN_DTYPE_BOOL:
        return sizeof(char);
    case CHAOSUAN_DTYPE_I8:
        return sizeof(int8_t);
    case CHAOSUAN_DTYPE_I16:
        return sizeof(int16_t);
    case CHAOSUAN_DTYPE_I32:
        return sizeof(int32_t);
    case CHAOSUAN_DTYPE_I64:
        return sizeof(int64_t);
    case CHAOSUAN_DTYPE_U8:
    ...
    case CHAOSUAN_DTYPE_F32:
        return sizeof(float);
    case CHAOSUAN_DTYPE_F64:
        return sizeof(double);
    case CHAOSUAN_DTYPE_C16:
        return 2; // 2 bytes complex (not standard)
    case CHAOSUAN_DTYPE_C32:
        return 4; // 4 bytes complex
    case CHAOSUAN_DTYPE_C64:
        return 8; // 8 bytes complex
    case CHAOSUAN_DTYPE_C128:
        return 16; // 16 bytes complex
    case CHAOSUAN_DTYPE_INVALID:
    default:
        throw std::invalid_argument("Unsupported or invalid data type.");
    }
}

inline const char *dtype_to_str(chaosuanDataType_t dtype) {
    switch (dtype) {
    case CHAOSUAN_DTYPE_BYTE:
        return "byte";
    case CHAOSUAN_DTYPE_BOOL:
